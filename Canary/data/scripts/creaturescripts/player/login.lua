...
function playerLoginGlobal.onLogin(player)
	...
	player:sendTextMessage(MESSAGE_LOGIN, loginStr)
	 ...
	 -- Registrar o evento de Extended Opcode para todos os jogadores
    player:registerEvent("ExtendedOpcode")

	-- Verifica se � o personagem dummy de cria��o
    if player:getName() == "Alma" then
        local destino = Position(666, 666, 15) -- Coordenadas do Sal�o dos Destinos
        ...
        -- O NPC Or�culo iniciar� o di�logo automaticamente via onCreatureAppear
    end
