...
Inclui o reset do personagem "Alma" e teletransporte para o Salão dos Destinos.
--]]
...
function playerLoginGlobal.onLogin(player)
    ...
    if player:getName():sub(1, 6) == "Guest_" then
        ...
        -- Limpa inventário (esvazia slots)
        ...
        -- Teleporta para o Salão dos Destinos (coordenadas já testadas)
    ...
    -- =========================================================================
    -- GERENCIAMENTO DE PROMOÇÃO (ignorado para Alma Vocation(0))
    -- =========================================================================
    ...
    -- ... (restante do script permanece igual, sem alterações)
